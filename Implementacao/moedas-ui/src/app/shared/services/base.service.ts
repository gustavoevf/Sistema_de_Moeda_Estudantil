...
export class BaseService {
  ...
  protected async post(url: string, data: any) {
    return this.http
      .post(this.baseUrl + url, data, this.httpHeaders)
      .pipe(
        tap({
          error: (error: any) => {
            if (error.status === 500) {
  ...
  protected async put(url: string, data: any) {
    return this.http
      .put(this.baseUrl + url, data, this.httpHeaders)
      .pipe(
        tap({
          error: (error: any) => {
            if (error.status === 500) {
  ...
  protected async get(url: string): Promise<any> {
    return this.http
      .get(this.baseUrl + url, this.httpHeaders)
      .pipe(
        tap({
          error: error => {
            if (error.status === 500) {
  ...
  protected async delete(url: string): Promise<any> {
    return this.http
      .delete(this.baseUrl + url, this.httpHeaders)
      .pipe(
        tap({
          error: error => {
            if (error.status === 500) {
